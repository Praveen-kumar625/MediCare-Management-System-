...
MediCare Management System uses [Contributor Covenant v2.0](https://contributor-covenant.org/version/2/0/code_of_conduct) as the code of conduct. The full text is included [below](#contributor-covenant-code-of-conduct) in English, and translations are available from the Contributor Covenant organisation:
...
For reporting issues in spaces related to MediCare Management System, please use the project's GitHub Issues at [https://github.com/Praveen-kumar625/MediCare-Management-System-/issues](https://github.com/Praveen-kumar625/MediCare-Management-System-/issues). Project maintainers commit to:
...
For escalation, please open a GitHub issue or contact the project lead Praveen Kumar Jayswal through the project repository.
