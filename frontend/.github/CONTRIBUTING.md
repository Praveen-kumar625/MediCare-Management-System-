# Welcome to the MediCare Management System Contributing Guide!

Before contributing, please read the [code of conduct](https://github.com/Praveen-kumar625/MediCare-Management-System-/blob/master/.github/CODE_OF_CONDUCT.md).

## 1. Check out the [MediCare Management System General Contributing Guide](https://github.com/Praveen-kumar625/MediCare-Management-System-/blob/master/.github/CONTRIBUTING.md) for how to:
...
to MediCare Management System. You could install and run CouchDB in any way you wish. For convenience, we have added a docker compose file in the
...
2. Configure `REACT_APP_MEDICARE_API=http://localhost:5984` environment variable in `.env`
...
Open a file named `.env` and add a line `REACT_APP_MEDICARE_API=http://localhost:5984` if you don't have it yet.
...
`npm run test:ci <file name>` e.g. `npm run test:ci src/__tests__/MediCare.test.tsx` will run that specific test file
...
- For a list of i18n language codes, see [this](https://github.com/Praveen-kumar625/MediCare-Management-System-/tree/master/src/locales/README.md).
